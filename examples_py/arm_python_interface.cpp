...
PYBIND11_MODULE(unitree_arm_interface, m){
    ...
    py::class_<LowlevelState>(m, "LowlevelState")
        ...
        .def("getGripperQ", &LowlevelState::getGripperQ)
        .def("getGripperQd", &LowlevelState::getGripperQd)
        .def("getGripperTau", &LowlevelState::getGripperTau)
        .def_readwrite("endPosture", &LowlevelState::endPosture)
        .def_readwrite("q", &LowlevelState::q)
        .def_readwrite("dq", &LowlevelState::dq)
        .def_readwrite("ddq", &LowlevelState::ddq)
        .def_readwrite("tau", &LowlevelState::tau)
        .def_readwrite("temperature", &LowlevelState::temperature)
        .def_readwrite("errorstate", &LowlevelState::errorstate)
        .def_readwrite("isMotorConnected", &LowlevelState::isMotorConnected)
        ;

    py::class_<LowlevelCmd>(m, "LowlevelCmd")
        .def_readwrite("q", &LowlevelCmd::q)
        .def_readwrite("dq", &LowlevelCmd::dq)
        .def_readwrite("tau", &LowlevelCmd::tau)
        .def_readwrite("kp", &LowlevelCmd::kp)
        .def_readwrite("kd", &LowlevelCmd::kd)
        .def_readwrite("twsit", &LowlevelCmd::twsit)
        .def_readwrite("posture", &LowlevelCmd::posture)
        .def("setZeroDq", &LowlevelCmd::setZeroDq)
        .def("setZeroTau", &LowlevelCmd::setZeroTau)
        .def("setZeroKp", &LowlevelCmd::setZeroKp)
        .def("setZeroKd", &LowlevelCmd::setZeroKd)
        .def("setControlGain", py::overload_cast<>(&LowlevelCmd::setControlGain))
        .def("setControlGain", py::overload_cast<std::vector<double>, std::vector<double>>(&LowlevelCmd::setControlGain))
        .def("setQ", py::overload_cast<std::vector<double>>(&LowlevelCmd::setQ))
        .def("setQ", py::overload_cast<VecX>(&LowlevelCmd::setQ))
        .def("setQd", &LowlevelCmd::setQd)
        .def("setTau", &LowlevelCmd::setTau)
        .def("setPassive", &LowlevelCmd::setPassive)
        .def("setGripperGain", py::overload_cast<>(&LowlevelCmd::setGripperGain))
        .def("setGripperGain", py::overload_cast<double, double>(&LowlevelCmd::setGripperGain))
        .def("setGripperZeroGain", &LowlevelCmd::setGripperZeroGain)
        .def("setGripperQ", &LowlevelCmd::setGripperQ)
        .def("getGripperQ", &LowlevelCmd::getGripperQ)
        .def("setGripperQd", &LowlevelCmd::setGripperQd)
        .def("getGripperQd", &LowlevelCmd::getGripperQd)
        .def("setGripperTau", &LowlevelCmd::setGripperTau)
        .def("getGripperTau", &LowlevelCmd::getGripperTau)
        ;
    ...
    py::class_<CtrlComponents>(m, "CtrlComponents")
        ...
        .def_readwrite("lowstate", &CtrlComponents::lowstate)
        ;
